-- Add buy_now_price to lots table
-- This allows sellers to set a "Buy Now" price that buyers can pay to immediately purchase the vehicle

ALTER TABLE lots
  ADD COLUMN IF NOT EXISTS buy_now_price NUMERIC(12,2);

-- Update the place_bid function to check buy_now_price
